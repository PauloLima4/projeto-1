export default function App() {
  return (
    <div>
      ...
      <h1>React</h1>
      <p>A biblioteca para interfaces de usuário web e nativas.</p>
      <button>Aprenda React</button>
      <button>Referência da API</button>
      <hr />
      <h1>Crie interfaces de usuários de componentes</h1>
      <p>React permite que você construa interfaces de usuários a partir
        de pedaços individuais chamados componentes.
      </p>
      <hr />
      <h1>Escreva componentes com códigos e marcação</h1>
